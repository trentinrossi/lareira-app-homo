...
import { CasalComponent } from 'app/entities/casal/casal.component';
import { CasalService } from 'app/entities/casal/casal.service';
import { Casal } from 'app/shared/model/casal.model';

describe('Component Tests', () => {
  describe('Casal Management Component', () => {
    let comp: CasalComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CasalComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.casals && comp.casals[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
